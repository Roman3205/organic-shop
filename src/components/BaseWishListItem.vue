<template>
  <div class="w-full grid-cols-12 border-gray-0 grid py-3 px-5 items-center">
    ...
    <p class="line-clamp-1 text-gray-9 pr-6 col-span-3 font-semibold">
      &#36;{{ price.toFixed(2) }}
    </p>
    <div class="flex items-center col-span-4 justify-between">
      ...
      <div class="flex items-center gap-5">
        <button
          ...
          class="text-center text-base font-medium hover:opacity-65 transition duration-500 rounded-3xl py-4 px-5"
        >
          Add to Cart
        </button>
        <TheCrossIcon
...
const stockCheck = computed(() => useStock(props.value.inStock))
</script>
